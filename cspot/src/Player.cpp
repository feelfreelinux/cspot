...
void Player::handleLoad(std::shared_ptr<TrackReference> trackReference, std::function<void()> &trackLoadedCallback, uint32_t position_ms)
{
    ...
    auto track = std::make_shared<SpotifyTrack>(this->manager, trackReference, position_ms);
